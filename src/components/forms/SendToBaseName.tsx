...
export default function SendToBaseName({view, setView}: any) {
  ...
  return (
    <>
      <form className="border mt-36 z-50 md:mt-0 w-fullmax-w-[550px] md:min-w-[550px] border-[#DFE1E6] dark:border-[#04308E] rounded-[10px] bg-white dark:bg-[#0B0B2F] pt-[22px] pb-[55px] px-10">
